  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.yonghuzhanghao" label="用户账号" prop="yonghuzhanghao">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="毕业年份" prop="biyenianfen">
          <el-input v-model="ruleForm.biyenianfen" 
              placeholder="毕业年份" clearable  :readonly="ro.biyenianfen"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="毕业年份" prop="biyenianfen">
              <el-input v-model="ruleForm.biyenianfen" 
                placeholder="毕业年份" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="所在地区" prop="suozaidiqu">
          <el-input v-model="ruleForm.suozaidiqu" 
              placeholder="所在地区" clearable  :readonly="ro.suozaidiqu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="所在地区" prop="suozaidiqu">
              <el-input v-model="ruleForm.suozaidiqu" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="薪酬" prop="xinchou">
          <el-input v-model="ruleForm.xinchou" 
              placeholder="薪酬" clearable  :readonly="ro.xinchou"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="薪酬" prop="xinchou">
              <el-input v-model="ruleForm.xinchou" 
                placeholder="薪酬" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="校友简介" prop="xiaoyoujianjie">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.xiaoyoujianjie" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.xiaoyoujianjie" label="校友简介" prop="xiaoyoujianjie">
                    <span v-html="ruleForm.xiaoyoujianjie"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yonghuxingming = true;
          ...
          if(o=='biyenianfen'){
            this.ruleForm.biyenianfen = obj[o];
	    this.ro.biyenianfen = true;
            continue;
          }
          if(o=='tupian'){
	    ...
	    this.ro.tupian = true;
          ...
          if(o=='suozaidiqu'){
            this.ruleForm.suozaidiqu = obj[o];
	    this.ro.suozaidiqu = true;
            continue;
          }
          if(o=='xinchou'){
	    ...
	    this.ro.zhiye = true;
          ...
          if(o=='xiaoyoujianjie'){
            this.ruleForm.xiaoyoujianjie = obj[o];
	    this.ro.xiaoyoujianjie = true;
            continue;
          }
        }
      }
    ...
    yonghuzhanghaoChange () {
      this.$http({
        ...
        if (data && data.code === 0) {
              ...
              if(data.data.biyenianfen){
                this.ruleForm.biyenianfen = data.data.biyenianfen
              }
        } else {
          this.$message.error(data.msg);
        }
	...
	this.ruleForm.xiaoyoujianjie = this.ruleForm.xiaoyoujianjie.replace(reg,'../../../social/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `xiaoyouxinxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.xiaoyouxinxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
